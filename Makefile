srcdir = /root/code/php5-5.5.9+dfsg/ext/rollerphp
builddir = /root/code/php5-5.5.9+dfsg/ext/rollerphp
top_srcdir = /root/code/php5-5.5.9+dfsg/ext/rollerphp
top_builddir = /root/code/php5-5.5.9+dfsg/ext/rollerphp
EGREP = /bin/grep -E
SED = /bin/sed
CONFIGURE_COMMAND = './configure' '--with-phpcrawl=/usr/include/curl'
CONFIGURE_OPTIONS = '--with-phpcrawl=/usr/include/curl'
SHLIB_SUFFIX_NAME = so
SHLIB_DL_SUFFIX_NAME = so
ZEND_EXT_TYPE = zend_extension
RE2C = exit 0;
AWK = nawk
shared_objects_rollerphp = rollerphp.lo
PHP_PECL_EXTENSION = rollerphp
PHP_MODULES = $(phplibdir)/rollerphp.la
PHP_ZEND_EX =
...
prefix = /usr
phplibdir = /root/code/php5-5.5.9+dfsg/ext/rollerphp/modules
